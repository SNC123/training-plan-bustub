...
class BPlusTreeInternalPage : public BPlusTreePage {
 public:
  ...
  auto InsertLvKeyRv(ValueType left_value, KeyType key, ValueType right_value, KeyComparator key_comparator) -> bool;
  auto GetTargetPageIdByKey(KeyType key, KeyComparator key_comparator) const -> ValueType;
